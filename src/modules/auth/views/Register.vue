<template>
    ...
    <form @submit.prevent="onSubmit" class="login100-form validate-form p-b-33 p-t-5">
      ...
      <div class="wrap-input100 validate-input" data-validate = "Ingrese Nombre">
        <input v-model="userForm.name" class="input100" type="text" placeholder="Ingrese Nombre" required>
        <span class="focus-input100" data-placeholder="&#xe82a;"></span>
      </div>

      <div class="wrap-input100 validate-input" data-validate = "Ingrese Usuario">
        <input v-model="userForm.email" class="input100" type="email" placeholder="Ingrese Correo" required>
        <span class="focus-input100" data-placeholder="&#xe818;"></span>
      </div>
  ...
  setup(){
    ...
    return {
      ...
      onSubmit: async()=> {
         ...
         else router.push({ name: 'daybook-no-entry'})
      }
    }
  }
